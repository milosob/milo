...
namespace milo::primitive::detail
{
    ...
    class cipher_chacha_impl_hw_x86_64_avx_2_ietf
    {
    public:
    ...
    public:
        ...
        static
        constexpr size_t block_ratio = 8;
    ...
    public:
        ...
        {
            return milo_primitive_detail_cipher_chacha_impl_hw_x86_64_avx_2_ietf_transform(
                uint64_t(rounds),
                uint64_t(a_blocks),
                a_state_ptr,
                reinterpret_cast<uint8_t*>(a_dst_ptr),
        ...
        {
            return milo_primitive_detail_cipher_chacha_impl_hw_x86_64_avx_2_ietf_generate(
                uint64_t(rounds),
                uint64_t(a_blocks),
                a_state_ptr,
                reinterpret_cast<uint8_t*>(a_dst_ptr)
    ...
    using cipher_chacha_impl_hw_x86_64_avx_2_ietf = void;
