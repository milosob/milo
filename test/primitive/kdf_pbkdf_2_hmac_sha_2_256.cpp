...
) noexcept(false) -> int
{
    ...
    TEST_CPLTIME(kdf_pbkdf_2_hmac_sha_2_256);
    
    TEST_RUNTIME(kdf_pbkdf_2_hmac_sha_2_256);
    TEST_RUNTIME(kdf_pbkdf_2_hmac_sha_2_256_sw);
    TEST_RUNTIME(kdf_pbkdf_2_hmac_sha_2_256_hw_x86_64_ni);
    
    TEST_DIFFERENTIAL(kdf_pbkdf_2_hmac_sha_2_256, kdf_pbkdf_2_hmac_sha_2_256_sw);
    TEST_DIFFERENTIAL(kdf_pbkdf_2_hmac_sha_2_256, kdf_pbkdf_2_hmac_sha_2_256_hw_x86_64_ni);
    TEST_DIFFERENTIAL(kdf_pbkdf_2_hmac_sha_2_256_sw, kdf_pbkdf_2_hmac_sha_2_256_hw_x86_64_ni);
