...
) noexcept(true) -> size_t
{
    ...
    {
        auto result = milo::primitive::aead::test<t_impl>::encrypt(
            test_vector.key,
            test_vector.iv,
            test_vector.aad,
...
) noexcept(false) -> int
{
    ...
    TEST_CPLTIME(aead_chacha_20_poly_1305);
    
    TEST_RUNTIME(aead_chacha_20_poly_1305);
    TEST_RUNTIME(aead_chacha_20_sw_poly_1305_sw);
